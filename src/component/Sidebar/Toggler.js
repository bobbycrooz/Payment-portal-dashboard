...
const Toggler = () => {
    return (
        <Switch>
            <input type="checkbox" id="switchBox1" className="switch__input"/>
            <label arial-hidden="true" className="switch__label" htmlFor='switchBox1'/>
            <div className='switch__marker' arial-hidden='true'></div>
        </Switch>
    )
}
